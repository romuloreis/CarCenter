...
namespace CarCenter.Controllers
{
    public class VendedorsController : Controller
    {
        ...
        public VendedorsController(CarCenterContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Vendedor != null ? 
                          ...
                          Problem("Entity set 'CarCenterContext.Vendedor'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'CarCenterContext.Vendedor'  is null.");
            }
            var vendedor = await _context.Vendedor.FindAsync(id);
            if (vendedor != null)
            {
